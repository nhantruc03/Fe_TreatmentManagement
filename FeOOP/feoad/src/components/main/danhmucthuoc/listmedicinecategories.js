...
class listmedicinecategories extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
        ...
        if (this.state.data !== null) {
            return (
                <div className='mt-1'>
                    <div className="row">
                        ...
                        <div className="col">
                            <Link className="link" to={`/addmedicinecategories`} >
            ...
            return (
                <div className='mt-5'>
                    ...
                    <div onClick={() => this.onAddClick()} className="btn btn-block btn-success"><i className="fa fa-edit" />+ Tạo mới</div>
                </div>
            )
        }
    }
...
export default listmedicinecategories;